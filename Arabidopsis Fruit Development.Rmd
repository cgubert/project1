...
Both NEV and EVR promote fruit growth, as indicated by reduction in fruit length in both mutants. Compared to WT, *nev* fruit are `r ((means["nev"])/(means["WT"])*100)` % as long (`r means[["nev""]]` +/- `r stDevs[["nev""]]`)
