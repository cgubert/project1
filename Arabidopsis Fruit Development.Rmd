...
Loss of NEV or EVR activity reduces the length of fruit by `percent[["nev"]]`% and `percent[["evr"]]`%, repectively. 
...
#ugly stats
t.test(fruitdata$WT,fruitdata$evr)
t.test(fruitdata$WT,fruitdata$nev)
```
