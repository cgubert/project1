...
colMeans(fruitdata)
#plot fruitdata
barplot(means,axisnames=FALSE,ylim=c(0,14),main="Fruit Length",xlab="Genotype",ylab="length(mm)")
#create vector of bar mid-points
mp<-barplot(means,col="dodgerblue3",ylim=c(0,14),main="Fruit Length",xlab="Genotype",ylab="length(mm)")
#label bars
